  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      const getScrollAmount = () => {
        const lastEl = document.getElementById("step-12-final");
      ...
      >
        ...
        <div
          ...
          style={{
            display: "flex",
            height: "100%",
            width: "calc(100vw + 7500px)", // Dynamic width: Part 1 (100vw) + Part 2 (Fixed pixels)
            position: "relative",
            zIndex: 2,
          }}
        >
          ...
          <div
            style={{
              width: "7500px", // Fixed pixel width to match the absolute pixel positions
              height: "100%",
              flexShrink: 0,
              display: "flex",
              alignItems: "center", // Vertically center the roadmap track
              position: "relative",
            }}
          >
            {/* Inner track container to lock vertical proportions */}
            <div style={{ position: "relative", width: "100%", height: "900px" }}>
              ...
              <div
                style={{
                  position: "absolute",
                  left: "-184px", // Converted from -13.5vw
                  top: "320px", // Converted from 35%
                  width: "300px",
                  height: "160px",
                  zIndex: 1,
                  pointerEvents: "none",
              ...
              <div
                style={{
                  position: "absolute",
                  left: "280px", // Converted from 18vw
                  top: "405px", // Converted from 46%
                  width: "220px",
                  height: "100px",
                  zIndex: 1,
                  pointerEvents: "none",
              ...
              <div
                style={{
                  position: "absolute",
                  left: "-19px", // Converted from -1vw
                  top: "480px", // Converted from bottom 5%
                  width: "440px",
                  height: "290px",
                  borderRadius: "20px",
                  padding: "24px",
              ...
              <div
                style={{
                  position: "absolute",
                  left: "320px", // Converted from 20.5vw
                  top: "124px", // Converted from 8.5%
                  width: "440px",
                  height: "290px",
                  borderRadius: "20px",
                  padding: "24px",
              ...
              <div
                style={{
                  position: "absolute",
                  left: "630px", // Converted from 42vw
                  top: "415px", // Converted from 47%
                  width: "300px",
                  height: "120px",
                  zIndex: 1,
                  pointerEvents: "none",
              ...
              <DesktopFrame
                ...
                height="500px"
                style={{
                  left: "836px", // Converted from 54vw
                  top: "328px", // Converted from bottom 8%
                }}
              >
                <div style={{ width: "100%", height: "100%", overflow: "hidden", backgroundColor: "#ffffff" }}>
                  <LazyIframe
              ...
              <div
                style={{
                  position: "absolute",
                  left: "1400px", // Converted from 93vw
                  top: "320px", // Converted from bottom 44%
                  width: "400px",
                  height: "200px",
                  zIndex: 1,
                  pointerEvents: "none",
              ...
              <div
                style={{
                  position: "absolute",
                  left: "1690px", // Converted from 110vw
                  top: "520px", // Converted from bottom 5%
                  width: "440px",
                  height: "290px",
                  borderRadius: "20px",
                  padding: "24px",
              ...
              <div
                style={{
                  position: "absolute",
                  left: "2129px", // Converted from 138.5vw
                  top: "590px", // Converted from 76%
                  width: "120px",
                  height: "120px",
                  zIndex: 1,
                  pointerEvents: "none",
              ...
              <DesktopFrame
                ...
                height="500px"
                style={{
                  left: "2200px", // Converted from 140vw
                  top: "100px", // Converted from 10%
                }}
              >
                <div style={{ width: "100%", height: "100%", overflow: "hidden", backgroundColor: "#ffffff" }}>
                  <LazyIframe
              ...
              <div
                style={{
                  position: "absolute",
                  left: "2930px", // Converted from 188vw
                  top: "258px", // Converted from 16.5%
                  width: "114px",
                  height: "80px",
                  zIndex: 1,
                  pointerEvents: "none",
              ...
              <div
                style={{
                  position: "absolute",
                  left: "3040px", // Converted from 195vw
                  top: "195px", // Converted from 8%
                  width: "440px",
                  height: "290px",
                  borderRadius: "20px",
                  padding: "24px",
              ...
              <div
                style={{
                  position: "absolute",
                  left: "3300px", // Converted from 212vw
                  top: "485px", // Converted from 47%
                  width: "380px",
                  height: "150px",
                  zIndex: 1,
                  pointerEvents: "none",
              ...
              <DesktopFrame
                ...
                height="500px"
                style={{
                  left: "3557px", // Converted from 228vw
                  top: "310px", // Converted from bottom 8%
                }}
              >
                <div style={{ width: "100%", height: "100%", overflow: "hidden", backgroundColor: "#ffffff" }}>
                  <LazyIframe
              ...
              <div
                style={{
                  position: "absolute",
                  left: "4215px", // Converted from 271vw
                  top: "520px", // Converted from 50%
                  transform: "translateY(-50%)",
                  width: "300px",
                  height: "130px",
                  zIndex: 1,
              ...
              <div
                style={{
                  position: "absolute",
                  left: "4410px", // Converted from 284vw
                  top: "165px", // Converted from bottom 50%
                  width: "440px",
                  height: "290px",
                  borderRadius: "20px",
                  padding: "24px",
              ...
              <div
                style={{
                  position: "absolute",
                  left: "4850px", // Converted from 312.5vw
                  top: "342px", // Converted from 38%
                  width: "100px",
                  height: "100px",
                  zIndex: 1,
                  pointerEvents: "none",
              ...
              <PhoneFrame
                ...
                darkStatus={true}
                style={{
                  left: "4950px", // Converted from 319vw
                  top: "450px", // Center vertically
                  transform: "translateY(-50%)",
                  width: "340px", // Compact width
                  height: "660px", // Fixed pixel height
                }}
              >
                <div style={{ width: "100%", height: "100%", overflow: "hidden", backgroundColor: "#ffffff" }}>
                  <LazyIframe
              ...
              <div
                style={{
                  position: "absolute",
                  left: "5290px", // Right after the phone mockup
                  top: "450px",
                  width: "180px",
                  height: "100px",
                  zIndex: 1,
              ...
              <PhoneFrame
                ...
                darkStatus={true}
                style={{
                  left: "5470px", // Converted from 350vw
                  top: "450px", // Center vertically
                  transform: "translateY(-50%)",
                  width: "320px",
                  height: "660px",
              ...
              >
                <div style={{ width: "100%", height: "100%", overflow: "hidden", backgroundColor: "#020813", position: "relative" }}>
                  <Image
              ...
              {/* STEP 11: FINAL TEXT CTA */}
              <div
                style={{
                  position: "absolute",
                  left: "6000px", // Placed next to Step 10
                  top: "450px",
                  transform: "translateY(-50%)",
                  width: "800px",
                  display: "flex",
              ...
              >
                ...
                <button
                  style={{
                    background: "linear-gradient(90deg, #0f172a 0%, #005AD7 100%)",
                    ...
                    alignItems: "center",
                    gap: "10px",
                    boxShadow: "0 10px 30px rgba(0, 90, 215, 0.2)",
                    transition: "all 0.3s ease",
                  }}
                  onMouseEnter={(e) => {
                    e.currentTarget.style.transform = "translateY(-2px)";
                    e.currentTarget.style.boxShadow = "0 15px 40px rgba(0, 90, 215, 0.4)";
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.transform = "translateY(0)";
                    e.currentTarget.style.boxShadow = "0 10px 30px rgba(0, 90, 215, 0.2)";
                  }}
                >
                  Let's Get Started <span style={{ fontSize: "18px", fontWeight: "bold" }}>→</span>
                </button>
              </div>

              {/* STEP 12: SECOND PHONE MOCKUP (Same as Step 10) */}
              <PhoneFrame
                id="step-12-final"
                frameColor="#1e293b"
                darkStatus={true}
                style={{
                  left: "7000px", // Placed after the text CTA
                  top: "450px", // Center vertically
                  transform: "translateY(-50%)",
                  width: "320px",
                  height: "660px",
            ...
            </div> {/* End of inner track container */}
          </div>
        </div>
      </div>
